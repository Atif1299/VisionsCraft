...
window.initParticles = function() {
  ...
  if (typeof particlesJS === 'undefined') {
    console.error('particlesJS is not defined. Make sure the particles.js library is loaded.');
    return;
  }
  ...
  if (heroParticlesElement) {
    particlesJS('particles-js', {
      particles: {
        ...
        color: { value: ['#4361ee', '#3a0ca3', '#4cc9f0'] },
        shape: { type: 'circle' },
  ...
  const backgroundParticlesElement = document.getElementById('particles-background');
